---
description: "Run the moodle.inventory capability with evidence and safety controls."
---

# speckit.moodle.inventory
...
Read `.specify/extensions/moodle/skills/moodle.inventory/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.inventory` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
