---
description: "Run the moodle.baseline capability with evidence and safety controls."
---

# speckit.moodle.baseline
...
Read `.specify/extensions/moodle/skills/moodle.baseline/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.baseline` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
