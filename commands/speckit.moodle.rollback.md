---
description: "Run the moodle.rollback capability with evidence and safety controls."
---

# speckit.moodle.rollback
...
Read `.specify/extensions/moodle/skills/moodle.rollback/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.rollback` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
