---
description: "Run the moodle.document capability with evidence and safety controls."
---

# speckit.moodle.document
...
Read `.specify/extensions/moodle/skills/moodle.document/SKILL.md` and follow it as the authoritative procedure for this command.
