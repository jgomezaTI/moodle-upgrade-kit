---
description: "Run the moodle.validate capability with evidence and safety controls."
---

# speckit.moodle.validate
...
Read `.specify/extensions/moodle/skills/moodle.validate/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.validate` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
