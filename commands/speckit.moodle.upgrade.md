---
description: "Run the moodle.upgrade capability with evidence and safety controls."
---

# speckit.moodle.upgrade
...
Read `.specify/extensions/moodle/skills/moodle.upgrade/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.upgrade` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
