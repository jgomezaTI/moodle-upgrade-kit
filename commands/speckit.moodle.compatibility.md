---
description: "Run the moodle.compatibility capability with evidence and safety controls."
---

# speckit.moodle.compatibility
...
Read `.specify/extensions/moodle/skills/moodle.compatibility/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.compatibility` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
