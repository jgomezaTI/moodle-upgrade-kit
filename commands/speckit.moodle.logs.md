---
description: "Run the moodle.logs capability with evidence and safety controls."
---
...
Read `.specify/extensions/moodle/skills/moodle.logs/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.logs` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
