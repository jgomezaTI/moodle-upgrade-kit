---
description: "Run the moodle.database capability with evidence and safety controls."
---

# speckit.moodle.database
...
Read `.specify/extensions/moodle/skills/moodle.database/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.database` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
