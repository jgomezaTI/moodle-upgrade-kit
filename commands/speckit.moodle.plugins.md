---
description: "Run the moodle.plugins capability with evidence and safety controls."
---

# speckit.moodle.plugins
...
Read `.specify/extensions/moodle/skills/moodle.plugins/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.plugins` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
