---
description: "Run the moodle.endpoints capability with evidence and safety controls."
---

# speckit.moodle.endpoints
...
Read `.specify/extensions/moodle/skills/moodle.endpoints/SKILL.md` and follow it as the authoritative procedure for this command.
...
Execute the `moodle.endpoints` contract and write its declared evidence artifact(s) under `runs/<run-id>/`.
